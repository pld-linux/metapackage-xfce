...
Requires:	xfce4-fsguard-plugin >= 0.4.0
Requires:	xfce4-genmon-plugin >= 3.0
Requires:	xfce4-mount-plugin >= 0.5.4
Requires:	xfce4-mpc-plugin >= 0.3.2
Requires:	xfce4-netload-plugin >= 0.4.0
Requires:	xfce4-notes-plugin >= 1.6.0
Requires:	xfce4-places-plugin >= 1.0.0
Requires:	xfce4-quicklauncher-plugin >= 1.9.4
Requires:	xfce4-radio-plugin >= 0.2.1
...
Requires:	Thunar-thumbnailers >= 0.3.0
