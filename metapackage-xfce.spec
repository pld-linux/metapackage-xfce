...
Group:		X11/Applications
Requires:	xfce4-battery-plugin >= 1.0.4
Requires:	xfce4-cellmodem-plugin >= 0.0.5
Requires:	xfce4-clipman-plugin >= 1.2.3
Requires:	xfce4-cpufreq-plugin >= 1.0.0
Requires:	xfce4-cpugraph-plugin >= 1.0.0
Requires:	xfce4-datetime-plugin >= 0.6.1
Requires:	xfce4-dict-plugin
Requires:	xfce4-diskperf-plugin >= 2.5.3
...
Requires:	xfce4-mount-plugin >= 0.6.4
Requires:	xfce4-mpc-plugin >= 0.4.3
Requires:	xfce4-netload-plugin >= 1.1.0
Requires:	xfce4-notes-plugin >= 1.7.7
Requires:	xfce4-places-plugin >= 1.3.0
Requires:	xfce4-playercontrol-plugin >= 0.3.0
Requires:	xfce4-quicklauncher-plugin >= 1.9.4-3
Requires:	xfce4-radio-plugin >= 0.4.4
Requires:	xfce4-sensors-plugin >= 1.2.5
Requires:	xfce4-smartbookmark-plugin >= 0.4.4
Requires:	xfce4-systemload-plugin >= 1.1.0
Requires:	xfce4-time-out-plugin >= 1.0.1
...
Requires:	xfce4-xkb-plugin >= 0.5.4.3
...
Requires:	Thunar-media-tags-plugin >= 0.2.0
